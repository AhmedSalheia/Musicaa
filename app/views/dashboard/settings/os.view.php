                            ...
                            <ul class="p-20 nav flex-column">
                                ...
                                <li class="nav-item"><a href="javascript:void(0)" class="nav-link c-grey-800 cH-blue-500">
                                        <div class="peers ai-c jc-sb text-primary">
                                            <div class="peer peer-greed"><i class="mR-10 ti-angle-double-right"></i> <!-- ti-panel -->
                                            ...
                                            <table id="dataTable" class="table table-hover table-striped table-bordered" cellspacing="0"
                                                ...
                                                foreach ($themes as $theme)
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style='height: 100px' width='37' class='p-0'>
                                                            <div class='d-flex w-100 h-100 text-center align-items-center' style='flex-direction: column'>
                                                                <a href='<?= URL ?>langs/edit/<?= $theme->id ?>' title="edit" class='bg-info w-100 h-50 d-flex justify-content-center' style='flex-direction: column;max-width: 70px'><i class='text-white ti-pencil'></i></a>
                                                                <a href='<?= URL ?>langs/edit/<?= $theme->id ?>' title="change default settings" class='bg-secondary w-100 h-50 d-flex justify-content-center' style='flex-direction: column;max-width: 70px'><i class='text-white ti-layout'></i></a>
                                                                <a href='<?= URL ?>langs/delete/<?= $theme->id ?>' title="delete" class='bg-danger w-100 h-50 d-flex justify-content-center' style='flex-direction: column;max-width: 70px' onclick='if (!confirm("Do You Really Want To Delete This Language?")){return false}'><i class='text-white ti-close'></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
